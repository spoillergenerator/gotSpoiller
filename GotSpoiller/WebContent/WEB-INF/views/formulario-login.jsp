			...
			<div class="logmod__container">
                ...
                <input type="submit" value="Registrar" />
								...
								<div class="sminputs">
									<div class="input full">
										...
										<input class="string optional" maxlength="255" id="user-email"
											placeholder="Email" size="50" name="login" //>
									</div>
								</div>
								<div class="sminputs">
                    ...
                    <input type="submit" value="Entrar nas tarefas" />
							...
							<form accept-charset="utf-8" action="efetuaLogin" method="post"
								class="simform">
								<div class="sminputs">
									<div class="input full">
										<label class="string optional" for="user-name">Email*</label>
						...
						<div class="logmod__alter">
							...
							<form action ='fblogin' method='post'>
								<!--<input type='submit' class="connect facebook" value = "Sign in with Facebook">-->
