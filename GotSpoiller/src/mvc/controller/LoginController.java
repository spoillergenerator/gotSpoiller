...
//	}
	...
	public static void fbLogin() throws IOException, InterruptedException, ExecutionException {
		System.out.println("opa");
        // Replace these with your client id and secret
        final String clientId = "341972912918164";
        final String clientSecret = "90e3d5af558fc29fbdf07865a6492229";
        final String secretState = "secret" + new Random().nextInt(999_999);
        final OAuth20Service service = (OAuth20Service) new ServiceBuilder(clientId)
                .apiSecret(clientSecret)
                .state(secretState)
                .callback("http://localhost:8080/formulario-login")
...
//	public String fbLogin() throws IOException {
////		UsuarioDAO dao = new UsuarioDAO();
////		dao.adiciona(usuario);
////		return "redirect:loginForm";
//		OAuthService service = new ServiceBuilder("341972912918164")
//                .apiSecret("90e3d5af558fc29fbdf07865a6492229")
//                .build(FacebookApi.instance());
//		
//	}
