...
@Controller
public class FacebookMenuController {
...
//	}
	@RequestMapping(value = "/fblogin/sendMessage", method = RequestMethod.POST)
...
//			MandadorSMSal.send(mensagem);
	...
	@RequestMapping(value = "/fblogin/getHistory", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/fblogin/getSpoilers", method = RequestMethod.POST)
